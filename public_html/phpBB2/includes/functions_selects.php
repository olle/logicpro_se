 ...
 *
 *   $Id: functions_selects.php,v 1.2 2005/02/05 21:44:39 olle Exp $
 *
 *
 ***************************************************************************/
...
//
// Pick a forum for news update
function forum_select($default, $select_name = 'forum') {
	...
	if (!($result = $db->sql_query($sql))) {
		message_die(GENERAL_ERROR, "Couldn't query forum table.", "", __LINE__, __FILE__, $sql);
	}
