 ...
 *
 *   $Id: bbcode.php,v 1.2 2005/02/05 21:44:39 olle Exp $
 *
 ***************************************************************************/
...
function smilies_pass($message) {
	...
	if (!isset($orig)) {
		...
		for ($i = 0; $i < count($smilies); $i++) {
			...
			$repl[] = '<img src="'. $board_config['smilies_path'] . '/' . $smilies[$i]['smile_url'] . '" alt="' . $smilies[$i]['emoticon'] . '" border="0" align="absmiddle" />';
		}
	}
