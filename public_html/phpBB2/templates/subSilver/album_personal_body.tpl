...
<table width="750" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
  <tr>
	<td class="tttitle_left">
		<h1><a href="{U_ALBUM}">{L_ALBUM}</a> -&gt; <a class="maintitle" href="{U_PERSONAL_GALLERY}">{L_PERSONAL_GALLERY_OF_USER}</a></h1>
	</td>
  ...
  <!-- BEGIN no_pics -->
  <tr>
	<td class="pmid" colspan="2" align="center" height="90"><h2>{L_PERSONAL_GALLERY_NOT_CREATED}</h2></td>
  </tr>
  <!-- END no_pics -->
